...
| `DSPACE_FIELD_EMBARGO_LIFT`              | local.embargo.lift           | Name of metadata field where embargo date will be set                                                                                                       |
| `DSPACE_FIELD_EMBARGO_TERMS`             | local.embargo.terms          | Name of metadata field where embargo date will be set                                                                                                       |
